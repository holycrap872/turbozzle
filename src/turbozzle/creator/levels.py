...
LEVEL_05 = [
    ["x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x"],
    ["x", "p", "b", "p", "x", "x", "x", "r", "b", "r", "x", "x", "x"],
    ["x", "b", "x", "b", "x", "x", "x", "b", "x", "b", "x", "x", "x"],
    ["x", "b", "x", "b", "x", "x", "x", "b", "x", "b", "x", "x", "x"],
    ["x", "p", "b", "b", "b", "b", "b", "p", "x", "b", "x", "x", "x"],
    ["x", "x", "x", "b", "x", "x", "x", "x", "x", "b", "x", "x", "x"],
    ["x", "g", "b", "b", "b", "b", "r", "x", "x", "b", "x", "y", "x"],
    ["x", "x", "x", "b", "x", "x", "b", "x", "x", "b", "x", "b", "x"],
    ["x", "x", "x", "b", "x", "x", "b", "x", "x", "b", "x", "b", "x"],
    ["x", "x", "x", "b", "x", "x", "b", "x", "x", "b", "x", "b", "x"],
    ["x", "x", "x", "r", "b", "b", "r", "x", "x", "b", "x", "b", "x"],
    ["x", "x", "x", "x", "x", "x", "x", "x", "x", "p", "b", "p", "x"],
    ["x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x", "x"],
]
